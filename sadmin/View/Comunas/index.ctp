<div class="comunas index">
	...
	<tr>
		<td><?php echo h($comuna['Comuna']['id']); ?>&nbsp;</td>
		<td><?php echo h($comuna['Comuna']['name']); ?>&nbsp;</td>
		<td><?php echo h($comuna['Comuna']['active']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $comuna['Comuna']['id']), null, __('Are you sure you want to delete # %s?', $comuna['Comuna']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
