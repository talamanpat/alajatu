<div class="proveedores index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('name_company'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($proveedor['Proveedor']['name_company']); ?>&nbsp;</td>
		<td><?php echo h($proveedor['Proveedor']['address']); ?>&nbsp;</td>
		<td><?php echo h($proveedor['Proveedor']['active']); ?>&nbsp;</td>
		<td><?php echo h($proveedor['Proveedor']['comuna_id']); ?>&nbsp;</td>
		<td><?php echo h($proveedor['Proveedor']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($proveedor['Proveedor']['info']); ?>&nbsp;</td>
		<td class="actions">
